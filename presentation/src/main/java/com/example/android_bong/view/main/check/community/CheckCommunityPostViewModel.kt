...
import com.example.domain.usecase.user.GetMyCommunityPostUseCase
...
@HiltViewModel
class CheckCommunityPostViewModel @Inject constructor(
    private val getMyCommunityPostUseCase: GetMyCommunityPostUseCase,
    private val getUserUseCase: GetUserUseCase

) : ViewModel() {

    private val _uiState = MutableStateFlow(CheckCommunityPostUiState())
    ...
    fun fetchPosts() {
        ...
        fetchJob = viewModelScope.launch {
            ...
            val result = getMyCommunityPostUseCase()
